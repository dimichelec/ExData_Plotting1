...
plot(dat$DateTime, dat$Global_active_power, xlab = "", ylab = "Global Active Power", type = 'l', cex.axis=.75, cex.lab = .75)
plot(dat$DateTime, dat$Voltage, xlab = "datetime", ylab = "Voltage", type = 'l', cex.axis=.75, cex.lab = .75)
...
legend('topright', names(y), lty=1, col=c("black","red","blue"), cex=.75, y.intersp=.9, bty='n')

plot(dat$DateTime, dat$Global_reactive_power, xlab = "datetime", ylab = "Global_reactive_power", type = 'l', cex.axis=.75, cex.lab = .75)
